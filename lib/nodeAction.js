...
nodeAction.prototype.__replayCommand = function(actions){
	if(actions.length){	//FIXME should not need this
		//console.log("actions left to replay 2 : " + actions.length);
		...
		setTimeout(function(){
			...
			console.log("actions left to replay: " + actions.length);
			if(actions.length > 0){
				var delay = 10;	//seconds
				console.log("waiting " + delay + " seconds between commands...");
				setTimeout(function(){	//wait 3 seconds between commands
